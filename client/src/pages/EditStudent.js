...
const NewStudent = () => {
  ...
  useEffect(() => {
    const getStudent = async () => {
      ...
      if (response.ok) {
        ...
        setTimetables(json.timetable);
        setStudentPhone(json.phone);
        setStudentEmail(json.mail);
        setSchool(json.school);
        setFee(json.fee);
        setAddress(json.address);
        setGrade(json.grade.toString());
        setSubjects(json.subjects);
        setFather(json.parent_details.father.name);
        setFatherPhone(json.parent_details.father.phone);
        setFatherEmail(json.parent_details.father.mail);
        setMother(json.parent_details.mother.name);
        setMotherPhone(json.parent_details.mother.phone);
        setMotherEmail(json.parent_details.mother.mail);
      }
    };
  ...
  return (
    <div className="flex flex-col w-full mt-[100px] px-4">
      <h1 className="text-center font-bold text-3xl pb-5">Edit Student</h1>
      <form>
        <h1 className="text-left font-normal text-3xl"> Student Info </h1>
        {/* Personal Info */}
        <div className="my-3">
          <Input
            value={fname}
        ...
        <h1 className="text-left font-normal text-3xl mt-5"> TimeTable </h1>
